  ...
  head: () => ({
    meta: [
      ...
      { title: "Coro — Organiza tu boda completa por 27€" },
      {
        name: "description",
        content:
          "Checklist, presupuesto, invitados, proveedores y cronograma de tu boda en un solo plan. Pago único de 27€.",
      },
      { name: "author", content: "Coro" },
      { property: "og:title", content: "Coro — Organiza tu boda completa por 27€" },
      {
        property: "og:description",
        content:
          "Todo lo que los novios deben tener en cuenta, ordenado desde el primer día.",
      },
